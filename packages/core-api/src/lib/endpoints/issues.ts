...
export class IssuesEndpoint {
    ...
    async getIssues(
        ...
        const { fields, offset, limit, filters, staticParams, sort } = params;
     ...
     */
    async updateIssue(issueId: string, data: UpdateIssue): Promise<Issue> {
     ...
     */
    async patchIssue(issueId: string, data: Partial<UpdateIssue>): Promise<Issue> {
