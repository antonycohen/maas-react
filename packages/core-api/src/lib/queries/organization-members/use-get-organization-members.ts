...
export type GetOrganizationMembersParams = GetCollectionQueryParams<
    OrganizationMember,
    GetOrganizationMembersStaticParams
> & {
...
export const useGetOrganizationMembers = (
    params: GetOrganizationMembersParams,
    options?: Omit<UseQueryOptions<ApiCollectionResponse<OrganizationMember>, ApiError>, 'queryKey'>
) =>
    useQuery({
        queryKey: ['organization-members', params.filters?.organizationId, params],
