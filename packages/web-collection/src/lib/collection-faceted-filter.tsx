...
export interface CollectionFacetedFilterProps<TData, TValue> {
...
export function CollectionFacetedFilter<TData, TValue>({
    column,
    title,
    options,
}: CollectionFacetedFilterProps<TData, TValue>) {
