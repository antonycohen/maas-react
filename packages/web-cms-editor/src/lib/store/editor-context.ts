...
export type EditorContextType = {
    ...
    setSelectedPlugin: React.Dispatch<React.SetStateAction<EditorPlugin<any, any, any> | null>>;
...
// eslint-disable-next-line @typescript-eslint/no-empty-function -- Default context values are intentional no-ops
const noop = () => {};
...
const EditorContext = React.createContext<EditorContextType>({
    ...
    setContent: noop,
    setSelectedPlugin: noop,
    setSelectedBlockId: noop,
    setSelectedBlockContent: noop,
    setSettings: noop,
    getPluginFromBlockType: () => null,
    getPluginsForContext: () => [],
    deleteBlockById: noop,
    addBlock: noop,
