...
const tutorialItems: TutorialItem[] = [
    ...
    {
        label: 'Utilisez les boutons de prévisualisation situés en haut pour vérifier le rendu',
        demo: null,
    },
];
    ...
    return (
        <ul className="flex w-full flex-col gap-y-4">
            {tutorialItems.map((item, index) => (
                <li key={item.label} className="border-border flex items-center gap-x-2.5 rounded-lg border p-4">
