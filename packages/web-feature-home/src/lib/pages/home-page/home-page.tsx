...
export const HomePage = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="container mx-auto flex flex-col px-5 xl:px-0 gap-5 pb-10 pt-5">
      ...
      <div className="bg-zinc-900">
        <div className="container mx-auto flex flex-col gap-5 pb-10 pt-10 px-5 xl:px-0">
          <h2 className="font-heading text-2xl md:text-[34px] font-semibold leading-[40px] tracking-[-0.85px]">
      ...
      {/* Content Feed Section */}
      <div className="container mx-auto flex flex-col gap-5 pb-10 pt-5 px-5 xl:px-0">
        <h2 className="font-heading text-2xl md:text-[34px] font-semibold leading-[40px] tracking-[-0.85px]">
          <span className="text-brand-primary">L'actualité mathématique</span>
          <span className="text-black"> en continu</span>
        </h2>
