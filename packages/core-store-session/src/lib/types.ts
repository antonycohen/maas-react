import { ApiError, Configuration, MySubscriptionStatus, User } from '@maas/core-api-models';
...
export type SessionActions = {
    ...
    setSubscriptionStatus: (subscriptionStatus: MySubscriptionStatus | null) => void;
    resetSession: () => void;
};
