...
type ControlledCategoryInputProps<T extends FieldValues> = {
...
export function ControlledCategoryInput<T extends FieldValues>(
  props: ControlledCategoryInputProps<T>,
) {
  const {
    name,
    label,
