  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 mt-8">
        <h2 className="text-2xl font-semibold font-barlow-semi-condensed text-red-600">Danger Zone</h2>
        <Card className="rounded-lg border-red-200">
          ...
          <CardFooter className="border-t justify-between bg-red-50/50 p-4">
