        ...
        {mode === 'select' && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Search for an existing article or create a new one to add to this folder.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-3 py-4">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Create a brand new article for this folder
                  </div>
                </div>
              </Button>
            </div>
          ...
          <FormProvider {...createForm}>
            <form onSubmit={createForm.handleSubmit(handleCreate)}>
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new article for this folder.
                </DialogDescription>
              </DialogHeader>
              <div className="py-4">
                <FieldGroup>
