...
import { IconFolder, IconFolderPlus, IconFile } from '@tabler/icons-react';
import { FolderWithArticles } from './folder-section';

type FoldersPanelProps = {
  folders: FolderWithArticles[];
  standaloneArticlesCount: number;
    ...
    <div className="flex h-full flex-col">
      ...
      <ScrollArea className="flex-1">
        <div className="p-2 space-y-1">
          ...
          {folders.length === 0 && standaloneArticlesCount === 0 && (
