...
export function useTeamMembersColumns(
  options: UseTeamMembersColumnsOptions,
  ...
  return [
    {
      ...
      accessorKey: 'email',
      header: ({ column }) => (
        <CollectionColumnHeader column={column} title="Member" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: 'role',
      header: ({ column }) => (
        <CollectionColumnHeader column={column} title="Role" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-1.5 bg-muted px-2 py-0.5 rounded-md w-fit">
    ...
    },
    {
      ...
      header: ({ column }) => (
        <CollectionColumnHeader column={column} title="Joined" />
      ),
      cell: ({ row }) => (
