...
function parseVideoUrl(url: string | null | undefined): ParsedVideo {
    ...
    if (dailymotionMatch) {
        ...
        return {
            ...
            thumbnails: [`https://www.dailymotion.com/thumbnail/video/${videoId}`],
        };
    }
                ...
                <div className="grid grid-cols-2 gap-3">
                    {thumbnails.map((thumb, index) => (
                        <button
                            ...
                            className="group hover:ring-primary relative aspect-video overflow-hidden rounded-md border transition-all hover:ring-2"
                        >
                            <img
                                src={thumb}
...
export function VideoPicker({
    ...
    const parsedVideo = useMemo(() => parseVideoUrl(value?.url), [value?.url]);
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2">
                <div
                    className={cn(
                        'bg-background flex flex-1 items-center gap-2 rounded-md border px-3 shadow-xs',
            ...
            {parsedVideo.embedUrl ? (
                <div className="flex flex-col gap-2">
                    <div className={cn('bg-muted relative aspect-video w-full overflow-hidden rounded-md border')}>
                        <iframe
                    ...
                    <div className="flex items-center justify-between">
                        <span className="text-muted-foreground text-xs capitalize">{parsedVideo.platform}</span>
                        <ThumbnailSelector
                ...
                <div className={cn('bg-muted flex aspect-video w-full items-center justify-center rounded-md border')}>
                ...
                <div
                    className={cn(
                        'bg-muted flex aspect-video w-full items-center justify-center rounded-md border',
