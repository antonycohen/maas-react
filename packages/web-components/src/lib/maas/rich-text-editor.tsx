...
import { $getRoot, $insertNodes, EditorState, FORMAT_TEXT_COMMAND } from 'lexical';
import { cn } from '@maas/core-utils';
import { Bold, Italic, Underline, Strikethrough } from 'lucide-react';
import { Button } from '../ui/button';
import { EquationNode, EquationPlugin, EquationDialog, EquationToolbarButton } from './lexical';
    ...
    return (
        <>
            <div className="border-input flex gap-1 border-b p-1">
                ...
                {enableEquation && <EquationToolbarButton onClick={() => setShowEquationDialog(true)} />}
            </div>
            {enableEquation && <EquationDialog open={showEquationDialog} onOpenChange={setShowEquationDialog} />}
        </>
    );
}
